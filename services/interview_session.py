...
class InterviewSessionManager:
    ...
    def update_session(self, session_id: str, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if "messages" in updates:
                updates["messages"] = [{"type": update.type, "content": update.content, "additional_kwargs": update.additional_kwargs} for update in updates["messages"]]
    ...
    def get_soft_skills_summary(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            all_metrics = self.redis.lrange(metrics_key, 0, -1)  # BUG FIX: was redis_client, should be self.redis
